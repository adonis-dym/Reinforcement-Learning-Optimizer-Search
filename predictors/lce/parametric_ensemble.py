...
from predictors.lce.parametric_model import ParametricModel
...
class ParametricEnsemble:
    ...
    def mcmc(self, x, N=10000, var=0.0001, fit_weights=False, verbose=False):
        ...
        # initialize with mle estimates for each model
        self.fit(x, fit_weights)
        ...
        for t in range(N):
            ...
            for j in range(curvelen):
                ...
                min_point_likelihood = min(
                    min_point_likelihood, point_likelihood)
